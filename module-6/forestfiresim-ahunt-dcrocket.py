...
# Lake size (in the middle of the forest):
LAKE_WIDTH = 15
LAKE_HEIGHT = 6
    ...
    while True:  # Main program loop.
        ...
        for x in range(forest['width']):
            for y in range(forest['height']):
                ...
                # Water never changes and cannot burn or grow trees.
                if forest[(x, y)] == WATER:
...
def createNewForest():
    ...
    # create forest with trees and empty spaces
    ...
    # create lake in the middle of the forest
    lakeLeft = (WIDTH - LAKE_WIDTH) // 2
    lakeTop = (HEIGHT - LAKE_HEIGHT) // 2
    for x in range(lakeLeft, lakeLeft + LAKE_WIDTH):
        for y in range(lakeTop, lakeTop + LAKE_HEIGHT):
            forest[(x, y)] = WATER
